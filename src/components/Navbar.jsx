			...
			<div>
				<div className='sidenav '>
					<div>
						...
						<Link to='/album' className='greenborder libraryGreen'>
							<svg
								className='mr-2 mb-2'
								xmlns='http://www.w3.org/2000/svg'
								width='24'
					...
					<div className='navFoot'>
						<a href='/' type='button' className='btn btn-secondary loginBtn text-dark'>
							Sign Up
						</a>
						<a type='button' href='index.html' className='btn btn-dark loginBtn'>
							Login
						</a>
					...
					<div className='row'>
						...
						<div className='col-9 col-md-9'>
							...
							<div className='row bottomMiddle'>
								<div className='col-1 songtime py-1 ' style={{ textAlign: "right" }}>
									00:00
								</div>
								<div className='col-8'>
